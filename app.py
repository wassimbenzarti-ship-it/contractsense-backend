...
def analyze_contract(contract_text, lang, contract_type, api_key, partie="la partie bénéficiaire", file_bytes=None, filename="", progress_cb=None):
    ...
    system = (
        ...
        "RÈGLE ABSOLUE — MODÈLES DU DIRECTEUR (PRIORITÉ MAXIMALE):\n"
        "Lorsqu'un modèle de contrat (section MODÈLES DE CONTRATS ci-dessus) couvre le même article ou sujet "
        "que le contrat analysé, ton proposed DOIT reprendre les termes EXACTS du modèle :\n"
        "- délais précis (ex: renégociation 30 jours, résolution 90 jours, préavis 12 mois)\n"
        "- indemnités et montants (ex: indemnité 24 mois, indemnisation intégrale)\n"
        "- mécanismes juridiques (ex: CIRDI à Paris, pas CNUDCI; résolution avec indemnisation, pas simple résiliation)\n"
        "INTERDIT d'inventer tes propres délais, montants ou mécanismes si le modèle du directeur en prévoit.\n"
        "Adapte uniquement les noms des parties et l'objet du contrat — conserve toujours la substance du modèle.\n\n"
